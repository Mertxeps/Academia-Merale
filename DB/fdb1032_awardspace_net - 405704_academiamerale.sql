...
-- Tiempo de generación: 10-07-2023 a las 18:23:43
...
--
-- Base de datos: `4057040_academiamerale`
--
DROP DATABASE IF EXISTS `4057040_academiamerale`;
CREATE DATABASE IF NOT EXISTS `4057040_academiamerale` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `4057040_academiamerale`;
...
CREATE TABLE `profesores_cursos` (
  ...
  `horas` tinyint NOT NULL COMMENT 'Entre 120 y 240 horas'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `usuarios` (`id_usuario`, `email`, `password`, `nombre`, `foto`, `autorizacion`) VALUES
(1, 'yo@yo.com', '1234', 'Mertxe', '14b6dd5ecde68fe55b406b9bd871836a', 1);
...
--
ALTER TABLE `cursos`
  MODIFY `id_curso` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `inscripciones`
--
ALTER TABLE `inscripciones`
  MODIFY `id_inscripcion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
